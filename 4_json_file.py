"""
Скрипт демонструє роботу з JSON-файлами в Python:
- Створення та запис даних.
- Читання даних з файлу та їх фільтрація.
- Додавання нових даних та оновлення файлу.
- Керування файлом (видалення).
"""
...
# Визначаємо ім'я файлу та повний шлях до файлу
filename = "books.json"
...
# Записуємо новий список назад у файл
with open(file_path, "w", encoding="utf-8") as file:
